...
const translations = {
  en: {
    ...
    startRecording: "Start recording to preserve cultural heritage.",
    ...
    deleteConfirmationBtn: "Delete", // Fixed duplicate "delete" key
    welcome: "Welcome",
    ...
    uploadBtn: "Upload", // Fixed duplicate "upload" key
    ...
    enterRecordingTitleAgain: "Enter recording title", // Fixed duplicate "enterRecordingTitle" key
    wordItem: "Word", // Fixed duplicate "word" key
    ...
    deleteAction: "Delete", // Fixed duplicate "delete" key
  ...
  hi: {
    ...
    startRecording: "सांस्कृतिक विरासत को संरक्षित करने के लिए रिकॉर्डिंग शुरू करें।",
    ...
    deleteConfirmationBtn: "हटाएं", // Fixed duplicate "delete" key
    welcome: "स्वागत है",
    ...
    uploadBtn: "अपलोड करें", // Fixed duplicate "upload" key
    ...
    enterRecordingTitleAgain: "रिकॉर्डिंग शीर्षक दर्ज करें", // Fixed duplicate "enterRecordingTitle" key
    wordItem: "शब्द", // Fixed duplicate "word" key
    ...
    deleteAction: "हटाएं", // Fixed duplicate "delete" key
